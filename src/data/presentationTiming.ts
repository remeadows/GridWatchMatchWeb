...
export const MATCH_RECOGNITION_HOLD_MS = 60;
export const MATCH_POP_COMPRESSION_MS = 55;
export const MATCH_IMPACT_MS = 120;
export const MATCH_AFTERIMAGE_MS = 90;
...
export const MATCH_WAVE_PER_GRID_MS = 22;
export const MATCH_WAVE_MAX_MS = 80;
export const CASCADE_START_AFTER_IMPACT_MS = 125;
export const CASCADE_FALL_BASE_MS = 145;
export const CASCADE_FALL_PER_CELL_MS = 50;
export const CASCADE_FALL_MIN_MS = 195;
export const CASCADE_FALL_MAX_MS = 380;
export const CASCADE_LANDING_SQUASH_MS = 65;
